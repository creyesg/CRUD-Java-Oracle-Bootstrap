...
import beans.sessions.EnviosFacade;
...
public class EnviosController implements Serializable {
    ...
    @EJB
    private beans.sessions.EnviosFacade ejbFacade;
    ...
    public Envios getEnvios(java.lang.Long id) {
    ...
    public static class EnviosControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Envios) {
                ...
                return getStringKey(o.getEnvioId());
            } else {
