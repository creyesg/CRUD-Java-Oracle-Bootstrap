...
@FacesConverter(value = "paqueteConverter")
public class PaqueteConverter implements Converter {

    private PaqueteFacade ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Paquete) {
            ...
            return getStringKey(o.getCodPaquete());
        } else {
    ...
    private PaqueteFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(PaqueteFacade.class).get();
